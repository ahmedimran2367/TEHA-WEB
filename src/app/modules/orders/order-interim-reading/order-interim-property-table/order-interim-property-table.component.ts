...
@Component({
  selector: 'app-order-interim-property-table',
  templateUrl: './order-interim-property-table.component.html',
  styleUrls: ['./order-interim-property-table.component.scss']
})
export class OrderInterimPropertyTableComponent implements OnInit, AfterViewInit {
  ...
  data: any;
  @Output()
  interimPropertyEvent = new EventEmitter();
  constructor(
  ...
  createOrder(id): void {
    ...
    this.interimPropertyEvent.emit(this.data);
  }
