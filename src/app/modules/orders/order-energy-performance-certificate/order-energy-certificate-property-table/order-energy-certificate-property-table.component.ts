...
@Component({
  selector: 'app-order-energy-certificate-property-table',
  templateUrl: './order-energy-certificate-property-table.component.html',
  styleUrls: ['./order-energy-certificate-property-table.component.scss']
})
export class OrderEnergyCertificatePropertyTableComponent implements OnInit, AfterViewInit {
  ...
  data: any;
  @Output()
  postPropertyEvent = new EventEmitter();
  constructor(
  ...
  createOrder(id): void {
    ...
    this.postPropertyEvent.emit(this.data);
  }
