...
@Component({
  selector: 'app-order-plumbing-property-table',
  templateUrl: './order-plumbing-property-table.component.html',
  styleUrls: ['./order-plumbing-property-table.component.scss']
})
export class OrderPlumbingPropertyTableComponent implements OnInit, AfterViewInit {
  ...
  data: any;
  @Output()
  plumbingPropertyEvent = new EventEmitter();
  constructor(
  ...
  createOrder(id): void {
    ...
    this.plumbingPropertyEvent.emit(this.data);
  }
