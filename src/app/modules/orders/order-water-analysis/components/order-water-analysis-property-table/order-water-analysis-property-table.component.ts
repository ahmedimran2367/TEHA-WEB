...
@Component({
  selector: 'app-order-water-analysis-property-table',
  templateUrl: './order-water-analysis-property-table.component.html',
  styleUrls: ['./order-water-analysis-property-table.component.scss']
})
export class OrderWaterAnalysisPropertyTableComponent implements OnInit, AfterViewInit {
  ...
  data: any;
  @Output()
  waterAnalysisPropertyEvent = new EventEmitter();
  constructor(
  ...
  createOrder(id): void {
    ...
    this.waterAnalysisPropertyEvent.emit(this.data);
  }
