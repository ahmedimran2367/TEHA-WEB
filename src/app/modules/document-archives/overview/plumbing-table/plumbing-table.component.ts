...
@Component({
  selector: 'app-plumbing-table',
  templateUrl: './plumbing-table.component.html',
  styleUrls: ['./plumbing-table.component.scss'],
})
export class PlumbingTableComponent
  ...
  displayColumnsProperty = ['title', 'creationDate', 'download'];
  displayColumnsFlats = [
    'tehaUserNo',
    'rentNo',
    'adminUserNo',
  ...
  ngOnChanges(changes: SimpleChanges): void {
    this.documentArchivesService
      .getDocuments(null, 'P', true, true, false)
      .subscribe(
        (m) => {
  ...
  downloadDocument(id: number, level: string): void {
    this.documentArchivesService
      .downloadDocumentContent(id, 'P', level)
      .subscribe(
        (m) => {
