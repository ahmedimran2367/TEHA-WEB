 ...
 */
export class LanguageTableDataSource extends DataSource<LanguageSetting> {
   ...
   */
  connect(): Observable<LanguageSetting[]> {
   ...
   */
  private getPagedData(data: LanguageSetting[]): LanguageSetting[] {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: LanguageSetting[]): LanguageSetting[] {
    return data;
